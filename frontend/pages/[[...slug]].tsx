...
import { MetadataType, SectionDataType, PagesType } from '../utils/types';
...
export const getStaticPaths: GetStaticPaths = async () => {
  ...
  const pages = (await (
    await fetch(getStrapiURL('/pages'))
  ).json()) as PagesType[];
...
export const getStaticProps: GetStaticProps = async ({
  ...
  console.log('🚀 ~ file: [[...slug]].tsx ~ line 64 ~ params', params);
  ...
  console.log(
    '🚀 ~ file: [[...slug]].tsx ~ line 70 ~ chainedSlugs',
    chainedSlugs
  );
